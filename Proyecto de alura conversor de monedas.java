...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) { // este es el bucle inicial, y lo hice asi para poder usar las opciones cuantas
    ...
    // aqui abajo esta el codigo o mejor dicho las varias que utilize para hacer la
    // covercion entre todas las opciones
    static void convertir(double valorDeLosPesosRD, String pais) {
        ...
        // nota fue un poco complicado usar todas ociones con este solo codigo pero lo
        // logre espero que este bien realizado
        // si tienen algun consejo por favor mandarmelo. por que en verdad lo necesito
        // para mejorar
